 ...
 * ---------------------------------------------------------------------------
 * تنفيذ خاص بمشروع شركة بابل للتوظيف، يعمل بالكامل داخل المتصفح (offline).
...
(function (root, factory) {
  ...
  function selfTest(verbose) {
    ...
    check('ذهاب وعودة للبيانات وفحص بايتات التصحيح', function () {
      var words = ['BRC-000120', 'https://brc-babil.com/verify?form=BRC-000120&t=ab12', 'شركة بابل للتوظيف'];
